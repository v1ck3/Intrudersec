    ...
    <div className="fixed inset-0 z-50 flex justify-end bg-black/50">
      ...
      <div className="w-72 bg-[#0A1D4A]/70 backdrop-blur-md h-full p-6 text-white relative">
        ...
        <div className="mb-8">
          ...
          <p className="text-sm text-gray-300">Welcome back <span className="text-white font-bold">{name}</span></p>
          <p className="text-sm text-gray-300">Email: <span className="text-white font-bold">{email}</span></p>
        </div>
        ...
        <nav className="flex flex-col gap-4 text-sm font-medium">
          ...
          <Link to="/resources" onClick={onClose} className="hover:text-gray-300">
            Resources
          </Link>
          <button
