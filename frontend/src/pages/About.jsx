...
const About = () => {
  return (
    <section className=" bg-white max-w-8xl  px-6 py-16 text-center">
     <div data-aos="fade-up">
      ...
      {/* Description */}
      <p className="text-black mt-6 max-w-4xl mx-auto leading-relaxed">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mt-12 text-left max-w-4xl mx-auto">
        {/* What We Offer */}
        <div>
          <h4 className="text-2xl text-black font-semibold mb-3">What We Offer</h4>
        ...
        {/* Join Our Community */}
        <div>
          <h4 className="text-2xl text-black font-semibold mb-3">Join Our Community</h4>
          <ul className="space-y-2 text-black">
